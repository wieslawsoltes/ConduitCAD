...
export function isVisible(e, doc) { return !e.hidden && !e.feature3d?.suppressed && !(e.type==='MESH'&&e.model3dConsumed) && layerFor(e, doc)?.visible !== false && (e.layout || 'Model') === (doc.activeLayout || 'Model'); }
